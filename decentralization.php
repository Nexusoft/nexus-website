                ...
                <aside>
                  <div class="leftSideBar customNavBar">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link subMenu" id="sub1-tab" data-toggle="tab" href="#sub1" role="tab" aria-controls="sub1" aria-selected="false">Forks and Chain Splits</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link subMenu" id="sub2-tab" data-toggle="tab" href="#sub2" role="tab" aria-controls="sub2" aria-selected="false">Centralized Systems</a>
                      </li>
                      <li class="nav-item">
              ...
              <div class="col-lg">
                ...
                <div class="contentWrapper tab-content" id="myTabContent">
                  <div class="intro-Wrapper customTab tab-pane fade<?php echo isset($_REQUEST['s'])?'':' active show';?>" id="over" role="tabpanel" aria-labelledby="over-tab">
                    <div class="titleCol">
                      <p class="customText">Throughout history, we have seen the models of society move in cycles of varying degrees of centralization, from the formation of monarchies, oligarchies, to democracies, and republics. Our current governance systems are failing, and we believe this is because they are managed as top-down structures. Current voting systems deem their perspective encapsulates the value of the whole system, although it is evident that politicians continue to direct these systems in favor of their own values, disguising them as values of the people.</p>
                      <p class="customText">Nexus is building DAO (Decentralized Autonomous Organization) technology based on mathematical regulation to improve the overall network governance model. The DAO technology is being built to enable voting on the allocation of Nexus funds, though it will be able to be used by other organizations. It is the foundation of a meritocracy, where individuals with higher ability earn their way by merit to positions of greater influence.</p>
                  ...
                  <div class="customTab tab-pane fade" id="sub2" role="tabpanel" aria-labelledby="sub2-tab">
                    <div class="titleCol">
                      ...
                      <p class="customText">Today’s societies are organized by centralized bodies, with a ‘trusted’ authority in the form of governments, institutions and third parties. Trusted authorities authenticate and process information of these systems in order to determine ownership, legal agreements, and to settle disputes. Centralized systems have provided many useful technologies including central databases, ledgers for governments (e.g. titles and deeds, voting rolls, licenses, customs records, and digital I.Ds), and corporations (e.g. bank deposits, stock wealth, and legal contracts), or other services such as Google, Facebook and Cloud Providers. Though these records provide many benefits to society as a whole, they disproportionately profit a minority. Furthermore, the organizations that manage centralized databases often sell the data on to other organizations without the consent of the people. </p>
                      <p class="customText">From observing the political landscape around the world today, it is evident that democracy creates a two-party system, where many people feel unrepresented. Democracy often results in ‘mob rule’, as the majority decides for everyone. It allows the majority to ignore the minorities in decision making, inevitably producing conflict. The traditional approach of voting negates the weight associated with each corresponding value and individuals’ influence on society.</p>
