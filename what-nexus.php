...
?>
  ...
  <section>
    <div class="bannerSection inner_bg vision_bg">
  ...
  <section>
    <div class="colSpace smColSpace">
      <div class="container">
        <div class="customInner" style="max-width:750px;margin:auto;">
          <div class="headingCol customSpace">
            <h2>Mission</h2>
            <span class="customText">Developing open-source blockchain to support decentralization, innovative applications and responsible values.</span>
          </div>
          <div class="headingCol">
            <h2>Vision</h2>
            <span class="customText textJustify">Nexus is a peer-to-peer network, cryptocurrency, and contract technology that serves as an alternative to our current systems. It was built by a small group of innovative software architects, and is operated by a global decentralized community. Together, we envision a world in which there is greater trust and connection to one another.</span>
          </div>
          <div class="headingCol">
            <h2>Community</h2>
