      ...
      <div class="container">
        <div class="customInner" style="max-width:800px;margin:auto;">
          <div class="headingCol customSpace">
            ...
            <p class="customText textJustify">Applications on Nexus will be easily accessible through the technology we built called <a href="./signature-chains" target="_blank">Signature Chains</a>, a decentralized blockchain account that is authorized by a username, password, and pin. We believe this is an important step to a wider adoption of the technology.</p>
          </div>
