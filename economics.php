      ...
      <div class="container">
        <div class="customInner" style="max-width:850px;margin:auto">
          <div class="headingCol">
            <!-- <h2>NXS ECONOMICS</h2> -->
            <span class="customText textJustify">The first NXS block was mined on September 23rd of 2014 at 16:20:00 GMT – 7. The total supply as of 26th January 2019, is 78% of the September 2024 target of 78 million NXS. </p>

                        <p class="customText textJustify">The issuance of NXS is independent of a central bank or government, it has zero debt or interest associated with its distribution, and its supply is regulated by mathematics. This is in direct contrast to the creation of new loans of fiat currency by ‘Fractional Reserve Banking’, which people are required to pay back to a bank.</p>

                        <p class="customText textJustify">The process of creating NXS requires mining (similar to that of Bitcoin) or staking, which gives a base value to the currency backed by the physical resources required to create each individual coin. Both miners and stakers contribute real resources or equity to the Nexus ecosystem, such as energy, hardware, and time. In return, they receive newly created NXS. Defining the rewards to miners and stakers is very important. Too low and rewards are not significant enough to encourage nodes to mine and stake. Too high and the growth in supply could erode the value of the currency over time.</span>
          </div>
          <div class="headingCol">
            <h6>Annual Inflation</h6>
            <p class="customText textJustify">The growth rate in the supply of NXS is currently 1.20% per annum for Proof of Stake, and 5.08% per annum for Proof of Work totaling 6.28%. After September 2024, both Proof-of-Work channels combined will increase the supply by a maximum of 1 NXS per minute, resulting in the creation of 525,000 NXS per year or a maximum of 0.67% inflation per annum. The growth in supply of NXS from the Proof of Stake channel will be capped at a maximum of 3.00% per annum. This makes the post 2024 inflation a maximum of 3.67% that can only be realized if the entire NXS supply were staked at the maximum Stake rate. Currently it takes one year of consistent staking to build up enough Trust to earn a 3.00% rate of return.</p>
