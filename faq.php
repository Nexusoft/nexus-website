              ...
              <div class="col-lg">
                ...
                <div class="contentWrapper tab-content" id="myTabContent">
                  <div class="intro-Wrapper customTab tab-pane fade h6-dark<?php echo isset($_REQUEST['s'])?'':' active show';?>" id="parent1" role="tabpanel" aria-labelledby="parent1-tab">
                    ...
                    <div class="headingCol customSpace textJustify">
                      <h5>4. Is there a cap on the NXS supply?</h5>
                      <p>After an initial 10-year distribution period ending on September 23rd, 2024, there will be a total of 78 million NXS in circulation.</p>
                    </div> 
                    <div class="headingCol customSpace textJustify">
                      <h5>5. What is the economic model of Nexus?</h5>
                      <p>The issuance of NXS is independent of a central bank or government, the supply is regulated by mathematics. The creation of NXS has zero debt or interest associated with its distribution.</p>
                      <p>The first NXS block was mined on September 23rd of 2014 at 16:20:00 GMT – 7. The process of creating NXS requires mining (similar to that of Bitcoin) or staking, which gives a base value to the currency backed by the physical resources required to create each individual coin. Both miners and stakers contribute real resources or equity to the Nexus ecosystem, such as energy, hardware, and time. In return, they receive newly created NXS. Defining the rewards to miners and stakers is very important. Too low and rewards are not significant enough to encourage nodes to mine and stake. Too high and the growth in supply could erode the value of the currency over time. The process of creating NXS is very dissimilar from the creation of tokens via Initial Coin Offerings (ICOs), which are produced at zero cost, and are then sold on a secondary market.</p>
                      <p>The total supply as of 26th January 2019, is 78% of the September 2024 target of 78 million NXS, and the growth rate in the supply of NXS is currently 1.20184% per annum. After September 2024, the growth in supply of NXS will continue to be capped at a maximum of 3% per annum. This model is designed to produce an annual growth rate in the supply of a NXS, similar to the annual growth rate of the total world supply of gold. Gold is an asset which has often been favored in times of economic crisis as a hedge against the inflation of fiat currencies, due to the scarcity of its supply and difficulty to increase it.</p>
                      <p>Both Proof-of-Work channels combined will increase the supply by a maximum of 1 NXS per minute post 2024, resulting in the creation of 525,000 NXS per year. The Proof-of-Stake channel will increase the supply of NXS at a maximum of 3.0% per annum. A rate of 3.0% could only be realized if the entire NXS supply were staked at the maximum Stake rate, which currently takes one year of consistent staking to build up enough Trust to earn a 3.0% rate of return. The creation of NXS has zero debt or interest associated with its issuance and distribution. This is in direct contrast to the creation of new loans of fiat currency by ‘Fractional Reserve Banking’, which people are required to pay back to a bank.</p>
                  ...
                  <div class="customTab tab-pane fade" id="parent4" role="tabpanel" aria-labelledby="parent4-tab">
                    <div class="headingCol customSpace textJustify">
                      ...
                      <p class="mb-0"><b>Seven Layer Software Stack</b></p>
                      ...
                      <p class="mb-0"><b>Network Overlays</b></p>
                      ...
                      <p class="textCenter">&nbsp;<a href="../digitalcurrency/technology-pioneer-who-scaled-the-internet-is-now-helping-blockchain-do-the-same/">Technology Pioneer Who Scaled The Internet Is Now Helping Blockchain Do The Same</a></p>
                      <p class="mb-0"><b>Lower Level Library</b></p>
                      ...
                      <p class="mb-0"><b>Three Mining Channels</b></p>
                      ...
                      <p class="mb-0"><b>Signature Chains</b></p>
                      ...
                      <p>&nbsp;</p>
                      <p class="mb-0"><b>API Integration</b></p>
                      ...
                      <p></p>
                      <p class="mb-0"><b>Modules and Applications</b></p>
                      ...
                      <p></p>
                      <p class="mb-0"><b>Hybrid Blockchain</b></p>
                      ...
                      <p></p>
                      <p class="mb-0"><b>Three-Dimensional Chain</b></p>
