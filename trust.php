                ...
                <div class="contentWrapper tab-content" id="myTabContent">
                  <div class="intro-Wrapper customTab tab-pane fade show active" id="over" role="tabpanel" aria-labelledby="over-tab">
                    <div class="titleCol">
                      ...
                      <p class="innerText"><a href="https://community.nexus.io/files/tritium/NexusStakingWithTritiumTrust.pdf" class="btn btn-primary">Tritium Trust White Paper</a></p>
                      <p class="innerText"><a href="./stake" class="btn btn-primary">Stake</a></p>
                    </div>
                  </div>
