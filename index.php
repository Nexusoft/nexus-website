        ...
        <div class="row justify-content-center verticalMiddle">
          <div class="col-md-7 text-center">
            <div class="content-area whiteBg">
              ...
              <p class="textJustify">Nexus is a seven layered architecture that powers decentralized applications or ‘Dapps’. Our API provides direct access to develop with features such as Contracts, Tokens and Assets, without the need for specialist programming knowledge.</p>
            </div>
            <div class="btnRow">
          ...
          <div class="col-md-5">
            <div class="chainImg text-center">
              <img src="images/d-apps.svg" width="130" alt="chain" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-center">
            <div class="content-area whiteBg">
              ...
              <p class="textJustify">The Nexus Wallet is a secure desktop application for using the NXS cryptocurrency, allowing you to send and receive, view transaction history, and stake. The wallet features a platform to install and create modules for Dapps, and an interface that can be customized with your own skins.</p>
            </div>
            <div class="btnRow">
        ...
        <div class="row justify-content-md-end">
          <div class="col-lg-7">
            <div class="content-area coloredBg">
              ...
              <div class="des">
                <p class="textJustify">
                Nexus is accessible through technology we designed called ‘Signature Chains’, a decentralized blockchain account that allows you to login to your Nexus Wallet from any computer with a username, password, and pin. A Sigchain is a personal blockchain that provides the foundation for features such as digital identity and managing assets.
                </p>
              </div>
            </div>
            <div class="btnRow">
        ...
        <div class="row justify-content-center verticalMiddle">
          <div class="col-md-6 text-center">
            <div class="content-area whiteBg">
              ...
              <p class="textJustify">Nexus has integrated a number of cryptographic innovations that support increased levels of quantum resistance: an architecture called Signature Chains, FALCON, Argon2 and Keccak.</p>
            </div>
            <div class="btnRow">
